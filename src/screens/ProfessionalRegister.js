    ...
    const handleNext = () => {
        if (userData.name != '' && userData.email != '' && userData.password != '' && userData.phone != '' && userData.address != '' && confirmPassword != '') {
            if (confirmPassword === userData.password) {
                props.navigation.navigate("ProfessionalRegisterCategory", { name: userData.name, email: userData.email, password: userData.password, phone: userData.phone, address: userData.address })
            }
            else {
